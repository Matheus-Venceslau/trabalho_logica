...
// struct somente para salvar o cartÃ£o
typedef struct
{
	int codPedido;
...
{ // Funï¿½ï¿½o responsavel pela verificaï¿½ï¿½o da senha
...
void cadastrar_produtos()
{ // Funï¿½ï¿½o responsï¿½vel pelo cadastro de novos produtos
	// Declaracao de variaveis
	FILE *arquivo;
	arquivo = fopen("PRODUTOS.DAT", "a"); // Abrindo o arquivo no modo de alteraÃ§Ã£o ou criaÃ§Ã£o do arquivo
...
void salva_cartao(int codPedido)
{
	...
	// Formata: mostra 4 primeiros e 4 Ãºltimos
...
char *gerador_chave()
{ // Funï¿½ï¿½o para gerar a chave pix :)
	int i = 0;
...
void menu()
{ // Funï¿½ï¿½o responsï¿½vel por mostrar o menu, analisar a opï¿½ï¿½o escolhida e executar a funï¿½ï¿½o correspondente
	int escolha = 0;
	...
	} while (escolha > 4 || escolha < 0); // Limita dentro das opï¿½ï¿½es oferecidas
	...
	if (escolha == 1)
	{
		...
		if (autenticacao == 0)
		{ // Verificaï¿½ï¿½o se o usuario tem a permissï¿½o necessï¿½ria para cadastrar produtos
			printf("\nERRO: Acesso negado\n");
